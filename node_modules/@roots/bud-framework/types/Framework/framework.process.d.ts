 ...
 * @public
 */
export declare const makeTerminator: (app: Framework, options?: {
    timeout: number;
}) => (code: number, reason: string) => (err: Error, promise: any) => void;
/**
 ...
 * @public
 */
export declare const initialize: (app: Framework) => void;
//# sourceMappingURL=framework.process.d.ts.map
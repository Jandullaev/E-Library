...
class Service extends Bootstrapper_1.Bootstrapper {
     ...
     */
    get logger() {
        return this.app.logger.scoped(this.ident ?? this.constructor.name.toLowerCase());
    }
    /**
    ...
    dump(options) {
        this.app.log({
            message: (0, cli_highlight_1.default)((0, bud_support_1.format)(this.repository, {
                maxDepth: 2,
                ...options,
            })),
            prefix: this.ident,
        ...
        this.app.store.is('features.log', true) &&
            this.logger[type](...messages.reduce((acc, loggedItem) => {
                if (typeof loggedItem !== 'string' &&
                    ...
                    loggedItem.suffix = bud_support_2.chalk.dim(loggedItem.suffix.replace(process.cwd(), '.'));
                }

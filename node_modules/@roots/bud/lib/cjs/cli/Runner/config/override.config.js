...
const config = async (app, flags) => {
    /**
     * Handle --dist flag
     */
    if (typeof flags['location.project'] !== 'undefined') {
        app.setPath('project', flags['location.project']);
        app.children?.every((_name, child) => child.setPath('project', flags['location.project']));
    }
    /**
     * Handle --src flag
     */
    if (typeof flags['location.src'] !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.setPath('src', flags['location.src']));
    }
    /**
     * Handle --dist flag
     */
    if (typeof flags['location.dist'] !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.setPath('dist', flags['location.dist']));
    }
    /**
    ...
    if (typeof flags['publicPath'] !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.setPublicPath(flags['publicPath']));
    }
    /**
     * Handle --devtool flag
     */
    if (typeof flags.devtool !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.api.call('devtool', flags.devtool));
    }
    /**
     * Handle --devtool flag
     */
    if (typeof flags.hash !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.api.call('hash', flags.hash));
    }
    /**
     * Handle --devtool flag
     */
    if (typeof flags.html !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.api.call('html', flags.html));
    }
    /**
     * Handle --runtime flag
     */
    if (typeof flags.runtime !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.api.call('runtime', flags.runtime));
    }
    /**
    ...
    if (typeof flags.manifest !== 'undefined') {
        ...
        app.children?.every((_name, child) => child.store.set('features.manifest', flags.manifest));
    }
    /**
